...
# Edward Wallace, Edward.Wallace@ed.ac.uk, March 2025
...
def CodonFrequencyByAA(counts, genetic_code=11, outputtype="count"):
    r"""Calculates the synonymous codon frequency by AA for a set of codon counts.
    
    Args:
        counts (dict): Counts by codon, for example created by Count3mers(sequences)
...
# def CodonFrequencyByAATable(untable, genetic_code=11):
#     r"""Calculates the synonymous codon frequency by AA for a set of sequences.
# 
#     Args:
#         untable (list): The reference set of sequences.
#         genetic_code (int, optional): The translation table to use. Defaults to 11, the standard genetic code.
#     Returns:
#         dict: For each amino acid, a dict of codon counts or frequencies
# 
